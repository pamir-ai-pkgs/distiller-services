...
def _is_development() -> bool:
    ...
    """
    # Check if we're running from installed venv (production)
    # In production, __file__ is like: /usr/lib/distiller-services/.venv/lib/python3.X/site-packages/...
    if ".venv" in str(Path(__file__).resolve()):
        return False
...
def get_templates_dir() -> Path:
    ...
    3. /usr/lib/distiller-services/templates (production)
    ...
    return Path("/usr/lib/distiller-services/templates")
...
def get_static_dir() -> Path:
    ...
    3. /usr/lib/distiller-services/static (production)
    ...
    return Path("/usr/lib/distiller-services/static")
